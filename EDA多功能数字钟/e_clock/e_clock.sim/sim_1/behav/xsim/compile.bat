...
REM
REM Generated by Vivado on Tue Nov 18 19:42:54 +0800 2025
...
echo "xvlog --incr --relax -prj tb_cnt60_debug_vlog.prj"
call xvlog  --incr --relax -prj tb_cnt60_debug_vlog.prj -log xvlog.log
