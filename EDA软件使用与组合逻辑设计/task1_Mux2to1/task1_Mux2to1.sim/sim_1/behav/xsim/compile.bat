...
REM
REM Generated by Vivado on Tue Nov 11 08:14:01 +0800 2025
...
echo "xvlog --incr --relax -prj tb_Mux2to1s_vlog.prj"
call xvlog  --incr --relax -prj tb_Mux2to1s_vlog.prj -log xvlog.log
